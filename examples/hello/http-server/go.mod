module github.com/tim-pipi/cloudwego-api-gateway/examples/hello/http-server
...
require (
	...
	github.com/tim-pipi/cloudwego-api-gateway/http-server v0.0.0-20230713022640-f25f912702ae
)
